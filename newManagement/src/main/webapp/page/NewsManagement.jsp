                ...
                <div class="list" id="release_news">
                    ...
                    <div class="list_b_c" id="release_news_in">
                        <div class="release_news">
                        	<form action="${pageContext.request.contextPath }/news_add.action" method="post" id="addnews">
                            ...
                            <div class="release_news_ok_btn text_center" id="add_news_ok_btn" >发<i>我</i>布</div>
                        </div>
